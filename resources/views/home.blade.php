                    ...
                    <div class="card">
                        ...
                        <div class="card-footer">
                            <div class="row justify-content-between">
                                ...
                                <div class="col-sm"><p class="card-text">user: <b>{{ $post->user->name}}</b></p></div>

                                @Auth
                                @if(Auth::user()->id===$post->user_id)
                                <div class="col-sm me-2  ">
                                    <a href="{{ route('posts.edit', $post->id) }}"
                                        class="btn btn-outline-primary btn-sm"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-pen" viewBox="0 0 16 16">
